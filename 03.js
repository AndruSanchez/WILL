...
*/
function buscarAmigo(amigos, nombre) { // H: amigos =[{nombre:"Alejo" , edad:54},{...},{...}] , nombre= string
  // T: nombre="Alejo"  --> {nombre:"Alejo" , edad:54}
  ...
  // Ej: se busca el objeto que coincida con el nombre que nos pasan por parametro
